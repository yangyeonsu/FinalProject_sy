	...
	$(function()
	{
		$(".reviewTd").click(
				function()
				{
					...
					$(location).attr(
							"href",
							"reviewreportform.action?rep_apply_num="
									+ reportNum + "&state=" + state);
		...
		$(".errTd").click(
				function()
				{
					...
					$(location).attr(
							"href",
							"errreportform.action?req_apply_num=" + reportNum
									+ "&state=" + state);
		...
		$(".objTd").click(
				function()
				{
					...
					$(location).attr(
							"href",
							"objreportform.action?obj_apply_num=" + reportNum
									+ "&state=" + state);
		...
		$(".revoTd").click(
				function()
				{
					...
					$(location).attr(
							"href",
							"penaltyrevokeform.action?revo_apply_num="
									+ reportNum + "&state=" + state);
		...
		$(".inTd").click(
				function()
				{
					...
					if (catValue == "등록")
						$(location).attr(
								"href",
								"inapplyform.action?in_apply_num=" + idNum
										+ "&state=" + state);
					else
						$(location).attr(
								"href",
								"outapplyform.action?out_apply_num=" + idNum
										+ "&state=" + state);
				});
							...
							<c:forEach var="inout" items="${inoutList }" begin="0" end="4">
								<tr id="${inout.state }">
									...
									<c:if test="${inout.cat eq '폐업' }">
										<td class="outTd" style="background-color: pink;"
											id="${inout.report_num }">${inout.cat }</td>
